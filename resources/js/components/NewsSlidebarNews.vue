<template>
    ...
    <div class="text-right">
        ...
        <div v-for="item in news" class="row" style="margin-top:10px;box-shadow:0 0 4px #000000;">
            <div class="col-12 " style="background-color: #ffffff; direction: rtl; border-radius:5px;">
                ...
                <ul>
                    <li v-for="subItem in item.news">
                        <a :href="'/news/'+subItem.id+'/'+subItem.slug">
...
<script>
    export default {
        name: "NewsSlidebarNews",
        mounted() {
            axios.get('/api/newsSlidebarNews')
                .then(res=>{
                    this.news=res.data;
                })
                .catch(res=>{
